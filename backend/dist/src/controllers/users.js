...
const signUp = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (existingUsername) {
            throw (0, http_errors_1.default)(409, "User already taken. Please choose a different one or log in instead.");
        }
...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!username || !password) {
            throw (0, http_errors_1.default)(40, "Parameters missing");
        }
